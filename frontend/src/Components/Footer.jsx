          ...
          <div class="row">
            ...
            <div class="col-lg-4">
              <div class="footer-widget pl-lg-5 pl-0">
                ...
                <p style={{color:"black"}}>Subscribe for our Updates through email! </p>
                <div class="rounded border">
                  <form ref={form} onSubmit={sendEmail}>
            <div class="input-group">
              <input type="email" placeholder="Enter your email address" name="user_email" aria-describedby="button-addon1" class="form-control border-0 shadow-0" required/>
            ...
            <div class="col-md-12 d-flex align-items-center">
              ...
              <p style={{color:"black"}} class="mx-auto text-center mb-0">
                          Made with ❤️ by <a style={{
                            textDecoration: "none",
                             color:"purple",}} 
              href="https://aakanksha.is-a.dev/">Aakanksha</a> | Copyright {year}
              </p>
            </div>
          </div>
        </div>
