...
const clientId = "835855805452-eh8cmbqi3vfufgivh654qhv1fso1t8r2.apps.googleusercontent.com";
    ...
    <>
      <div class="container">
        <div class="row py-5 mt-1 align-items-center">
          ...
          <a onClick={() => history.push("/login")}><h4 style={{
              textAlign: "center",
                color: "black",
                fontFamily: "Pacifico",
                fontSize: "1.0 rem",
          }}>Already have an account?</h4></a>
